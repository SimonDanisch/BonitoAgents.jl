...
The tour below is real: claude-agent-acp sessions driving `bt_julia_eval`, a
live WGLMakie app it returned detached into the workspace and steered by its
slider, files opened from the project tree, and the dashboard keeping a rich
preview of every chat.
